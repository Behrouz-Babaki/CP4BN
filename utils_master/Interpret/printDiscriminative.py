...
def main():
    ...
    parser.add_argument("-d", "--binary-file2", help="the binary output file of cp itemset miner", required=True)
    parser.add_argument("-m", "--names-file2", help="the 'names' file produced by cp itemset miner", required=True)
    ...
    (lipmap2, threshold2, numVars2, numValsList2)  = readLikelyBin.likelyProbs(args.binary_file2)
