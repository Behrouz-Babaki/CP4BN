...
public class Itemset extends AbstractOrderedItemset{
	...
	/** the probability of this itemset */
	 ...
	 * Inherited from @AbstractOrderedItemset
	 */
	public int getAbsoluteSupport(){
		throw new RuntimeException("Someone is asking for absolute support!");
	}
	
	/**
	 * @return the probability of this itemset
	 */
	...
	public void setAbsoluteSupport(Integer support) {
		throw new RuntimeException("Someone is trying to change the absolute support!");
	}
	
	/**
	 * Set the probability of this itemset
