...
public class AssocRule extends Rule{
	...
	public AssocRule(int[] itemset1, int[] itemset2, int supportAntecedent,
		...
		this.lift = lift;
		throw new RuntimeException("Someone is trying to save a rule with a support value");
	}
	 ...
	 * @param lift   the lift of the rule
	 */
	public AssocRule(int[] itemset1, int[] itemset2, double probAntecedent,
			double prob, double confidence, double lift) {
		super(itemset1, itemset2, probAntecedent, prob, confidence);
		this.lift = lift;
	}
